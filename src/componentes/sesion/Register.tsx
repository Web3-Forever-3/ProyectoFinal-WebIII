  ...
  return (
    <div className="register_background">
      <div className="main_contenedor">
        ...
        <p>
          Registrarte como lector te permitirá publicar comentarios y valorar
          las investigaciones
        </p>
        <button onClick={() => navigate("/RegisterLector")}>
          Registrarse como lector
        </button>
        <p> o </p>
        <h3>Registrarse como Investigador</h3>
        <p>
          Registrarte como investigador te permitirá publicar tus
